...
- Heathrow dominates London air traffic, 1,546,667 flights over the period, nearly double Gatwick's 845,364, and more than the other four airports combined, and holds 9 of the top 10 busiest individual routes out of London
- Punctuality is not simply a long haul versus short haul story. Some long haul carriers show the worst average delays, Tunisair at 48.9 minutes and Air India at 38.0 minutes, while other long haul airlines, JetBlue at 9.0 minutes and Japan Airlines at 9.7 minutes, rank among the most punctual. The pattern is airline specific, not distance based
- Growth since 2023 has been uneven across airports. Luton shows the strongest, most consistent growth, up 2.6 per cent in 2024 and up 3.1 per cent in 2025, Heathrow and Gatwick grew initially but plateaued by 2025, and London City has stayed essentially flat
- Gatwick has the worst average delay of any London airport, 23.5 minutes, despite being only the second largest by volume
- London City has the worst cancellation rate, 2.96 per cent, more than double Heathrow's, despite the lowest average delay of all five airports, suggesting this smaller airport cancels more readily rather than absorbing delay the way the larger airports do
- Traffic is clearly seasonal, with a consistent summer peak in July and a winter trough every year from 2023 to 2025, and each summer's peak has been slightly higher than the last, a sign of steady growth in London flight volumes overall
